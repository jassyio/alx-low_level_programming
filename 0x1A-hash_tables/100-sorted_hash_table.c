...
/**
 * shash_table_create - creates a shash table with  given size
 *
...
/**
 * add_n_shash - adds a node at the beginning of  shash at a given index
 *
...
/**
 * add_i_shash - adds a node on the DLL of  shash table
 *
...
/**
 * shash_table_set - adds a hash (key, value) to given shash table
 *
...
/**
 *
 *  shash_table_print - prints the keys and values of shash table
 *
 * @ht: pointer to the shash table
 * Return: no return
 */
...
/**
 *
 * shash_table_print_rev - prints the keys and values of  shash table
 * in reverse
 *
 * @ht: pointer to the shash table
 * Return: no return
